...
export class SnapshotsService {
    ...
    async salvarSnapshot(entrada: {
        ...
        // Usamos upsert para atualizar o snapshot se ele já existir no mesmo minuto/período
        const snapshot = await this.prisma.snapshots.upsert({
            where: {
                jogo_id_periodo_tempo: {
                    jogo_id,
                    periodo,
                    tempo,
                },
            ...
            update: {
                ...
                capturado_em: new Date(), // Atualiza o timestamp para a atualização mais recente
            },
            create: {
                jogo_id,
                periodo,
